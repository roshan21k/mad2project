...
# All Category Request sent by current user(Manager)
...
# All product Request sent by current user(Manager)
...
# Fetching Category Details for frontend purpose
...
# Export product details as csv (celery)
